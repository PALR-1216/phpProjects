<?php
	...
	if($_FILES['fileToUpload']['name']!="") {
		$_SESSION['addstock']['photo']=$_FILES['fileToUpload']['name'];
		...
		if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
			...
			<div class="maincontent">
				...
				<p>Photo: <img src="images/photos/<?php echo $_SESSION['addstock']['photo']; ?>" /></p>
				...
				<?php
					...
					$catname_qry=mysqli_query($db, $catname_sql);
